...
public class env_pipe_handler {
    ...
    private static String [] token = new String[300000];
    ...
    private static void pipe_env_init(String[] args) throws IOException
    {
        first_step = true;
        try{            
            Class partypes[] = new Class[1];
            partypes[0] = Class.forName("[S");
        ...
        try{        
            ...
            else if ( Class.forName ( "[I" ).isInstance ( retobj2 ) )
            {
                ...
                for(int i=0;i< Array.getLength(retobj2);i++)
                    buf = buf + String.valueOf(Array.getInt(retobj2,i))+" "; TODO use StringBuilder 
                    buf = buf.trim();
                */

                //This is the new uptimized version
               	StringBuilder b = new StringBuilder();
            	int[] observation = (int[])retobj2;
            	b.append(observation[0]);
            	for (int i = 1; i < observation.length; i++) 
            	{
            		b.append(' ');
            		b.append(observation[i]);
				}
    ...
    private static void pipe_env_step() throws IOException
    {
        ...
        try{ 
            ...
            {
            	//This is the old unoptimized version
            	/*
                buf2 = "";
                ...
                //This is the new uptimized version
               	StringBuilder b = new StringBuilder();
            	int[] observation = (int[])retval.get(0);
            	b.append(observation[0]);
            	for (int i = 1; i < observation.length; i++) 
            	{
            		b.append(' ');
