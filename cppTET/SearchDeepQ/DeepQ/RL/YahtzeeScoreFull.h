...
// this structure contains the inner configuration of the game, that
// is completely independent from the state variables actually perceived
// by the agent
struct YahtzeeEnv
{
    // the number reroll left (0..3)
...
/**
 * Global state information (as perceived by the agent).
 */
...
#define STATE_ONES     1
#define STATE_TWOS     2
#define STATE_THREES   3
#define STATE_FOURS    4
#define STATE_FIVES    5
#define STATE_SIXES    6
#define STATE_TRIS     7
#define STATE_POKER    8
#define STATE_FULL     9
#define STATE_SMALL   10
#define STATE_LARGE   11
#define STATE_CHANCE  12
#define STATE_YAHTZEE 13

// the state space as perceived by the agent
struct
{
