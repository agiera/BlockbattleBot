...
sub BuildMenu #(FileName sourceFile, TopicType indexType, bool isFramed) -> string htmlMenu
    ...
    # Comment needed for UpdateFile().
    $output .= '<!--END_ND_MENU-->';
 $output .= '<center><script type="text/javascript"><!--
...
sub BuildFooter
    {
    my $self = shift;
    my $footer = '<div align="center"><a href="#top">TOP</a></div> ' . NaturalDocs::Menu->Footer();
    ...
    if (defined $footer)
        ...
        $footer .= '<br>'
			. '<a href="http://sourceforge.net"><img src="http://sourceforge.net/sflogo.php?group_id=93562&amp;type=1" width="88" height="31" border="0" alt="SourceForge.net Logo" /></a>'
			. '<br>Generated by <a href="' . NaturalDocs::Settings->AppURL() . '">Natural Docs</a>.'
        }
    else
        {
...
sub BuildIndexNavigationBar #(type, page, locations)
    ...
    $output .= '<br><br><script type="text/javascript"><!--
google_ad_client = "pub-7943942007953059";
google_ad_width = 468;
google_ad_height = 60;
