...
int main(int argc, char *argv[])
{
		...
		int test_length = 100000;
		int longrun_training_time = 10000000;
		...
		printf("\n**************************************************************\n");
		printf("Online learning performance, over %d episodes, is %10.4f reward per episode. Result averaged over %d runs. Standard error = %10.4f\n", training_time, mean_training_reward,num_runs,training_se); 
		printf("Agent trained for %d episodes. Asymptotic performance, over %d episodes, is %10.4f reward per episode. Result averaged over %d runs. Standard error = %10.4f\n",longrun_training_time, test_length, mean_testing_reward, num_runs,testing_se); 
		printf("**************************************************************\n");
