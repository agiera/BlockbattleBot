...
int main(int argc, char** argv)
{
	...
	if (argc != 3)
	{
		printf("Error: agent needs to know the name of the FIFO's\n");
		exit(1);
	}
    ...
    {    
        ...
        else if(strcmp(pipe_agent_buf,"getname") == 0)   
        {
            pipe_agent_get_name();
        }
...
void pipe_agent_get_name()
{
	...
	pipe_write(pipe_out_stream, agent_name);
#else
