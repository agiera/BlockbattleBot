...
const int MEMORY_SIZE=10000;                      //number of possible features 
const int  NUM_ACTIONS=3;                         //number of available actions   
const int  NUM_TILINGS=14;						  //number of tiling grids	
const int NUM_OBSERVATIONS=2;                     //dimension of observation
...
void computeActiveFeatures(double oo[NUM_OBSERVATIONS]);                                    
