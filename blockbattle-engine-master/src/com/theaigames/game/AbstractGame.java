	...
	public boolean isGameOver()
	{
		if (this.processor.isGameOver() 
			...
			for(IOPlayer ioPlayer : this.engine.getPlayers()) {
				if (this.processor.getWinner() != null && this.processor.getWinner().getBot() == ioPlayer) {
					try {
						ioPlayer.writeToBot("result won");
					} catch (IOException e) {
	                    System.out.println("won failed");
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
				} else {
					try {
						ioPlayer.writeToBot("result lost");
					} catch (IOException e) {
	                    System.out.println("lost failed");
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
				}
