...
logging.basicConfig(level=logging.DEBUG, filename='boterrors-2.log', filemode='w')
...
class Bot:
    def __init__(self, strategy):
        try:
            ...
            with open('botout-2.txt', 'w') as out:
                out.write('hi\n')
        except:
    ...
    def run(self):
        while not stdin.closed:
            try:
                ...
                with open('botout-2.txt', 'a') as out:
                    out.write(line + '\n')
